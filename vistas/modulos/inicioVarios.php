...
?>
    <main class="servicios py-1">
        <div class="container">
            <h2 class="text-xs-center font-weight-bold">Noticias</h2>


            <div class="row">
                <article class="col-md-4 wow bounceInLeft" data-wow-delay=".3s">
                    <img src="<?php echo $servidor; ?>/vistas/img/plantilla/tips.jpg" alt="Tip Financieros">
                ...
                <article class="col-md-4 wow bounceInUp" data-wow-delay=".6s">
                    <img src="<?php echo $servidor; ?>/vistas/img/plantilla/reclamo.png" alt="Requisitos para aplicar a un reclamo">
                    <h3><a href="#">Guia para presentar un reclamo</a></h3>
                ...
                <article class="col-md-4 wow bounceInRight" data-wow-delay="1s">
                    <img src="<?php echo $servidor; ?>/vistas/img/plantilla/requisitos.jpg" alt="Requisitos para aplicar a un préstamo">
                    <h3><a href="#">Requisitos para aplicar a un préstamo</a></h3>
