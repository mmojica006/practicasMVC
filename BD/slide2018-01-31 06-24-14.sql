...
INSERT INTO `crediweb`.`slide`(`id`,`imgFondo`,`tipoSlide`,`imgProducto`,`estiloImgProducto`,`estiloTextoSlide`,`titulo1`,`titulo2`,`titulo3`,`boton`,`url`,`fecha`) VALUES (1,'vistas/img/slide/slide1/slidepulperia.jpg','slideOpcion2','','','{
	...
	"left": "",
	"right": "10%"
}','{"texto": "SOMOS TU OPORTUNIDAD PARA CRECER" ,"color": "#333"}','{"texto": "TE OFRECEMOS LIQUIDEZ PARA DESARROLLAR TU NEGOCIO " ,"color": "#777"}','{"texto": "SOLICITA TU CREDITO AQUI" ,"color": "#888"}','<button class="btn btn-default backColor text-uppercase">
